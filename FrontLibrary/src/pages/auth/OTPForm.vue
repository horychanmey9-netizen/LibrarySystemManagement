    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="text-center">
          ...
          <p
            class="font-semibold text-slate-700 mt-1 break-all"
          >
            {{ email || "your email" }}
          </p>
        ...
        <div class="mt-8">
          ...
          <h2
            class="text-xl font-bold text-slate-800 text-center"
          >
            Enter OTP Code
          </h2>
          ...
          <!-- OTP Inputs -->
          <div
            class="flex justify-center gap-2 sm:gap-3 mt-8"
          >
            ...
            <input
              ...
              maxlength="1"
              class="w-11 h-14 sm:w-12 sm:h-14
          ...
          <p
            v-if="success"
            class="text-green-500 text-sm text-center mt-4"
          >
            {{ success }}
          </p>
...
// =========================
// NOTE:
// Your AuthController that you sent earlier
// does NOT have /resend-otp yet.
